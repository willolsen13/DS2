...
def main():
    ...
    while cap.isOpened():
        ...
        if result.gestures:
            ...
            while recognized_gesture == "Thumb_Up":
                pyautogui.keyDown("w")
            while recognized_gesture == "Thumb_Down":
                pyautogui.keyDown("s")
            while recognized_gesture == "Open_Palm":
                pyautogui.keyDown("a")
            while recognized_gesture == "Closed_Fist":
                pyautogui.keyDown("d")
            while recognized_gesture == "Victory":
